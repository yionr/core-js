...
QUnit.test('Set#isSubsetOf', assert => {
  ...
  assert.throws(() => isSubsetOf.call({}, new Set([1, 2, 3])), TypeError);
  assert.throws(() => isSubsetOf.call(undefined, new Set([1, 2, 3])), TypeError);
  assert.throws(() => isSubsetOf.call(null, new Set([1, 2, 3])), TypeError);
});
