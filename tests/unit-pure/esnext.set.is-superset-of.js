...
QUnit.test('Set#isSupersetOf', assert => {
  ...
  assert.throws(() => isSupersetOf.call({}, new Set([1, 2, 3])), TypeError);
  assert.throws(() => isSupersetOf.call(undefined, new Set([1, 2, 3])), TypeError);
  assert.throws(() => isSupersetOf.call(null, new Set([1, 2, 3])), TypeError);
});
